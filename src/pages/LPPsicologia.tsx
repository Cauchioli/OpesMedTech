        ...
        <section className="relative pt-24 md:pt-32 pb-14 md:pb-20 overflow-hidden bg-gradient-to-b from-white via-purple-50/30 to-white">
          <div className="container-custom relative">
            <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-6 space-y-5 text-left">
                ...
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-foreground tracking-tight leading-[1.15]">
                  ...
                  <span className="bg-gradient-to-r from-purple-600 via-violet-600 to-sky-600 bg-clip-text text-transparent">
                    Sigilo Ético e IA para Psicologia
                  </span>
                </h1>

                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed max-w-lg">
                  Anotações clínicas online com proteção total, acompanhamento de saúde mental, transcrição de voz com IA e agendamento por <strong className="text-foreground">R$ 199/mês</strong>.
                </p>
              ...
              {/* Right Column: Foto Oficial Psicologia */}
              <div className="lg:col-span-6 relative flex items-center justify-center">
                <div className="relative w-full max-w-lg aspect-16/10 rounded-3xl overflow-hidden shadow-2xl border-4 border-white bg-gradient-to-tr from-purple-100/60 to-sky-100/60">
                  <img
                    ...
                    alt="Psicóloga infantil com criança em atendimento acolhedor"
                  ...
                  <div className="absolute bottom-3 right-3 bg-white/95 backdrop-blur-md px-3.5 py-1.5 rounded-2xl border border-purple-100 shadow-md flex items-center gap-2">
                    ...
                    <span className="text-[11px] font-black text-purple-950">Sigilo Ético Absoluto</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="container-custom">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 max-w-5xl mx-auto">
              {[
                ...
                {
                  icon: FileText,
                  title: "Emissão de Laudos e Pareceres",
                  desc: "Modelos ágeis para relatórios, pareceres escolares e encaminhamentos.",
                },
                {
                  icon: Shield,
                  title: "Conformidade CRP e LGPD",
                  desc: "Criptografia de ponta a ponta e sigilo absoluto conforme o Código de Ética.",
                },
              ].map((item, index) => (
                <div
                  key={index}
